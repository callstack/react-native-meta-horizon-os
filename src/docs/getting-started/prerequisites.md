...
Alternatively, try [Expo Snack](https://snack.expo.dev/) in your browser for quick experimentation.
...
- **Meta Developer Account**: Required for publishing to Meta Horizon Store ([sign up](https://developers.meta.com/horizon/sign-up/))