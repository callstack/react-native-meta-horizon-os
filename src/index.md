...
features:
  ...
  - title: Existing Ecosystem
    details: Many React Native libraries work out of the box. Navigation, state management, networking.
    icon: 📦
  - title: Familiar Dev Tools
    details: Same debugging, profiling, and development workflow as mobile React Native apps.
    icon: 🛠️
---
